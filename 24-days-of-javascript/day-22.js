...
function displayTables() {
  ...
  return readyTables
    .map((table) => `<div class="table">TABLE ${table}</div>`)
    .join("");
}

const tables = document.getElementById("tables"); // Fetch the tables <section> from the DOM

tables.innerHTML = displayTables(); // Set the innerHTML content of the tables <section> to the displayTables function call.
